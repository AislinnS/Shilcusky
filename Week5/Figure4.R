...
data <- read.csv(file=("/Shilcusky/Documents/GitHub/Shilcusky/Week5/Figure4Data.csv"), header=T)
...
ggsave(filename=paste("/Shilcusky/Documents/GitHub/Shilcusky/Week5/Figure4Data.csv",
